...
import com.hrw.mvplibrary.log.Log;
...
public class SharedPreferencesUtil {
    ...
    public static void initSharedPreferencesUtil(Context context) {
        ...
        String[] processName = applicationInfo.processName.split("\\.");
        FILE_NAME = processName[processName.length - 1];
        Log.i("SharedPreferencesUtil初始化:存储名" + FILE_NAME);
    }
    ...
    public static void saveObject(String key, Object object) {
        SharedPreferences.Editor spEdit = mContext.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE).edit();
